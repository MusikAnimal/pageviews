        ...
        <div class='col-lg-10'>
          <ul class='list-group'>
            ...
            <li class='list-group-item'>
              ...
              <ul class='agents-ul'>
                <li><i>Users</i> includes all people who view a page. Editors, anonymous editors, and our readers.</li>
                <li>
                  <i>
                ...
                <li><i>Bots</i> are any other automated programs that may scrape pages for other purposes.</li>
              </ul>
            </li>
            <li class='list-group-item'>
              <p>
