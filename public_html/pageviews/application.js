 ...
 * @copyright 2016-2018 MusikAnimal, Kaldari, Marcelrf
  ...
  return function (_superclass) {
    ...
    _createClass(_class, [{
        ...
        return datasets.map(function (dataset, index) {
          ...
          dataset.forEach(function (elem) {
            ...
            if (_this4.app === 'metaviews') {
              date = elem.date;
            } else if (_this4.app === 'mediaviews') {
              date = moment(elem.date, _this4.config.mpcDateFormat).format(dateFormat);
            } else {
      ...
      value: function getApiUrl(entity, startDate, endDate) {
        ...
        var platform = $(this.config.platformSelector).val() || this.config.defaults.platform,
  ...
  _createClass(Pv, [{
    ...
    value: function setupDateRangeSelector() {
      ...
      if (this.daterangepicker) {
        ...
        var $datepicker = $(this.config.dateRangeSelector).remove();
      ...
      $(this.config.dateRangeSelector).off('apply.daterangepicker').on('apply.daterangepicker', function (e, action) {
    ...
    key: 'project',
    get: function get() {
      var project = this.app === 'mediaviews' ? 'commons.wikimedia.org' : $(this.config.projectInput).val();
