...
var SiteViews = function (_mix$with) {
  ...
  function SiteViews() {
    ...
    _this.monthStart = _this.config.initialMonthStart;
    _this.monthEnd = _this.config.maxMonth;
  ...
  _createClass(SiteViews, [{
    ...
    value: function setPlatformOptionValues() {
      ...
      $(this.config.platformSelector).find('option').each(function (index, el) {
        $(el).prop('value', _this4.isPageviews() ? $(el).data('value') : $(el).data('ud-value'));
      });
    }
    ...
    value: function setupDataSourceSelector() {
      ...
      $(this.config.dataSourceSelector).on('change', function (e) {
        ...
        if (wasMobileValue && _this5.isUniqueDevices()) {
          $(_this5.config.platformSelector).val('mobile-site'); // chart will automatically re-render
        } else if (wasMobileValue && _this5.isPageviews()) {
            $(_this5.config.platformSelector).val('mobile-web');
          }
    ...
    value: function processInput(force, removedSite) {
      ...
      if (removedSite) {
        ...
        this.getSiteStats(sites).then(function () {
          _this7.getPageViewsData(sites).done(function (xhrData) {
            return _this7.updateChart(xhrData);
          });
        });
      }
    }
    ...
    key: 'showSinglePageLegend',
    value: function showSinglePageLegend() {
    ...
    value: function validateProjects() {
      ...
      return projects.filter(function (project) {
        if (siteDomains.includes(project)) {
          ...
          _this9.writeMessage($.i18n('invalid-project', '<a href=\'//' + project.escape() + '\'>' + project.escape() + '</a>'));
          return false;
        }
      });
    }
...
var templates = {
  chartLegend: function chartLegend(scope) {
    var dataList = function dataList(entity) {
      var _$$i18n, _$$i18n2, _infoHash;

      var multiEntity = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

      // let editsLink;

      var infoHash = (_infoHash = {}, _defineProperty(_infoHash, $.i18n('pageviews'), (_$$i18n = {}, _defineProperty(_$$i18n, $.i18n('pageviews'), scope.formatNumber(entity.sum)), _defineProperty(_$$i18n, $.i18n('daily-average'), scope.formatNumber(entity.average)), _$$i18n)), _defineProperty(_infoHash, $.i18n('statistics'), (_$$i18n2 = {}, _defineProperty(_$$i18n2, $.i18n('pages'), scope.formatNumber(entity.pages)), _defineProperty(_$$i18n2, $.i18n('articles'), scope.formatNumber(entity.articles)), _defineProperty(_$$i18n2, $.i18n('edits'), scope.formatNumber(entity.edits)), _defineProperty(_$$i18n2, $.i18n('images'), scope.formatNumber(entity.images)), _defineProperty(_$$i18n2, $.i18n('users'), scope.formatNumber(entity.users)), _defineProperty(_$$i18n2, $.i18n('active-users'), scope.formatNumber(entity.activeusers)), _defineProperty(_$$i18n2, $.i18n('admins'), scope.formatNumber(entity.admins)), _$$i18n2)), _infoHash);
