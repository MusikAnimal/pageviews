...
},{"./zoom_plugin":7}],2:[function(require,module,exports){
'use strict';
...
var SiteViews = function (_mix$with) {
  ...
  _createClass(SiteViews, [{
    ...
    key: 'getSiteStats',
    value: function getSiteStats(sites) {
      var _this2 = this;
      ...
      var alwaysCallback = function alwaysCallback() {
        ...
        if (requestCount === sites.length) {
          dfd.resolve(_this2.entityInfo);
        }
      };

      sites.forEach(function (site) {
        // don't re-query for the same stats
        if (_this2.entityInfo.entities[site]) return alwaysCallback();
        ...
        $.ajax({
          ...
          _this2.entityInfo.entities[site] = data.query.statistics;
    ...
    value: function pushParams() {
      _get(SiteViews.prototype.__proto__ || Object.getPrototypeOf(SiteViews.prototype), 'pushParams', this).call(this, 'sites');
    }
    ...
    value: function setupSelect2() {
      ...
      _get(SiteViews.prototype.__proto__ || Object.getPrototypeOf(SiteViews.prototype), 'setupSelect2', this).call(this, params);
    }
    ...
    value: function setPlatformOptionValues() {
      ...
      this.$platformSelector.find('option').each(function (index, el) {
        $(el).prop('value', _this3.isPageviews() ? $(el).data('value') : $(el).data('ud-value'));
      });
    }
    ...
    value: function setupDataSourceSelector() {
      ...
      $(this.config.dataSourceSelector).on('change', function (e) {
        var platform = _this4.$platformSelector.val() || '',
            wasMobileValue = platform.includes('mobile'),
            wasPagecounts = _this4.params ? _this4.params.includes('pagecounts') : false;

        if (_this4.isPageviews()) {
          ...
          _this4.$agentSelector.prop('disabled', false);
        } else {
          // applies to unique devices and pagecounts
          ...
          _this4.$agentSelector.val('user').prop('disabled', true);
        }

        _this4.setPlatformOptionValues();
        ...
        if (wasMobileValue && !_this4.isPageviews()) {
          _this4.$platformSelector.val('mobile-site'); // chart will automatically re-render
        } else if (wasMobileValue && _this4.isPageviews()) {
          _this4.$platformSelector.val('mobile-web');
        }

        // re-init date selectors with new date range constraints, which will in turn call processInput()
        if (_this4.isPagecounts() || wasPagecounts) {
          _this4.setupDateRangeSelector();
          _this4.setupMonthSelector();
        } else {
          _this4.processInput();
        }
      });
    ...
    value: function setupListeners() {
      ...
      $('#date-type-select').on('change', function (e) {
        ...
        if (e.target.value === 'monthly') {
          ...
          _this5.setupMonthSelector();

          // Set values of normal daterangepicker, which is what is used when we query the API
          // This will in turn call this.processInput()
          _this5.daterangepicker.setStartDate(_this5.monthStartDatepicker.getDate());
          _this5.daterangepicker.setEndDate(moment(_this5.monthEndDatepicker.getDate()).endOf('month'));
        } else {
          _this5.processInput();
        }
      });
      $('.all-projects-radio').on('change', function (e) {
        $('.site-selector').toggleClass('disabled', e.target.value === '1');

        if (e.target.value === '0' && !_this5.getEntities()) {
          _this5.resetView();
          return _this5.setSelect2Defaults(config.defaults.projects);
        }
    ...
    value: function resetView() {
      ...
      _get(SiteViews.prototype.__proto__ || Object.getPrototypeOf(SiteViews.prototype), 'resetView', this).call(this, select2, clearMessages);
      this.$outputList.html('');
      $('.single-entity-ranking').html('');
    ...
    key: 'getEntities',
    value: function getEntities() {
      return this.isAllProjects() ? ['all-projects'] : _get(SiteViews.prototype.__proto__ || Object.getPrototypeOf(SiteViews.prototype), 'getEntities', this).call(this);
    }
    ...
    key: 'processInput',
    value: function processInput(force, removedSite) {
      var _this6 = this;

      var sites = this.beforeProcessInput(force);
      if (!sites) {
        return;
      }
      ...
      if (removedSite) {
        ...
        this.outputData = this.outputData.filter(function (entry) {
          return entry.label !== removedSite.descore();
        });
        ...
        this.getSiteStats(sites).then(function () {
          _this6.getPageViewsData(sites).done(function (xhrData) {
    ...
    value: function updateTable() {
      ...
      datasets.forEach(function (item, index) {
        _this7.$outputList.append(_this7.config.templates.tableRow(_this7, item));
      });
    ...
    value: function getSiteLink(site) {
      ...
      return _get(SiteViews.prototype.__proto__ || Object.getPrototypeOf(SiteViews.prototype), 'getSiteLink', this).call(this, site);
    }
    ...
    value: function showSingleEntityLegend() {
      var site = this.outputData[0];
      var pageviewsMsg = 'num-pageviews';
    ...
    value: function validateProjects() {
      ...
      return projects.filter(function (project) {
        if (siteDomains.includes(project)) {
          ...
          _this8.writeMessage($.i18n('invalid-project', '<a href=\'//' + project.escape() + '\'>' + project.escape() + '</a>'));
          return false;
        }
      });
    }
...
},{"../shared/chart_helpers":1,"../shared/pv":4,"../shared/site_map":6,"./config":8}],10:[function(require,module,exports){
'use strict';
...
var templates = {
  chartLegend: function chartLegend(scope) {
    ...
    var dataList = function dataList(entity) {
      ...
      var infoHash = _defineProperty({}, pageviewsMsg, {});
      ...
      if (scope.isAllProjects()) {
        var projects = ['wikipedia', 'wiktionary', 'wikiquote', 'wikibooks', 'wikisource', 'wikinews', 'wikiversity', 'wikispecies', 'wikivoyage'];
        var projectCounts = {};

        scope.siteDomains.forEach(function (domain) {
          var project = projects.filter(function (project) {
            return domain.includes(project);
          });
          if (project[0]) {
            var projectTrans = $.i18n(project[0]).upcase();
        ...
        infoHash[$.i18n('statistics')] = (_infoHash$$$i18n = {}, _defineProperty(_infoHash$$$i18n, $.i18n('pages'), scope.formatNumber(entity.pages)), _defineProperty(_infoHash$$$i18n, $.i18n('articles'), scope.formatNumber(entity.articles)), _defineProperty(_infoHash$$$i18n, $.i18n('edits'), scope.formatNumber(entity.edits)), _defineProperty(_infoHash$$$i18n, $.i18n('images'), scope.formatNumber(entity.images)), _defineProperty(_infoHash$$$i18n, $.i18n('users'), scope.formatNumber(entity.users)), _defineProperty(_infoHash$$$i18n, $.i18n('active-users'), scope.formatNumber(entity.activeusers)), _defineProperty(_infoHash$$$i18n, $.i18n('admins'), scope.formatNumber(entity.admins)), _infoHash$$$i18n);
      }
    ...
    var totals = {
      ...
      pages: scope.outputData.reduce(function (a, b) {
        return a + b.pages;
      }, 0),
      articles: scope.outputData.reduce(function (a, b) {
        return a + b.articles;
      }, 0),
      edits: scope.outputData.reduce(function (a, b) {
        return a + b.edits;
      }, 0),
      images: scope.outputData.reduce(function (a, b) {
        return a + b.images;
      }, 0),
      users: scope.outputData.reduce(function (a, b) {
        return a + b.users;
      }, 0),
      activeusers: scope.outputData.reduce(function (a, b) {
        return a + b.activeusers;
      }, 0),
      admins: scope.outputData.reduce(function (a, b) {
        return a + b.admins;
      }, 0)
    };
