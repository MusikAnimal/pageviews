  ...
  <body class="<?php echo $rtl; ?>">
    ...
    <div class="container">
      ...
      <main class="col-lg-10 col-lg-offset-1">
        <div>
          <?php $redirectviewsLink = "<pre dir='ltr' class='url-structure-example'>https://pageviews.toolforge.org/redirectviews?project=en.wikipedia.org&amp;pages={{FULLPAGENAMEE}}</pre>"; ?>
