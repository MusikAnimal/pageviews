  ...
  _createClass(PageViews, [{
    ...
    value: function popParams() {
      ...
      if (!params.pages || !params.pages.length) {
        this.getDefaultPages().done(function (pages) {
          ...
          setTimeout(_this2.stopSpinny.bind(_this2));
    ...
    value: function getDefaultPages() {
      ...
      if (this.project === 'en.wikipedia') {
        ...
        this.fetchSiteInfo(this.project).done(function (siteInfo) {
    ...
    value: function processInput(force, removedPage) {
      ...
      var getPageViewsAndAssessments = function getPageViewsAndAssessments(entities) {
        _this7.getPageViewsData(entities).done(function (xhrData) {
          _this7.getPageAssessments(xhrData.entities).then(function (assessments) {
            for (var page in assessments) {
              _this7.entityInfo.entities[page].assessment = assessments[page];
            }
    ...
    value: function showSinglePageLegend() {
      ...
      $.ajax({
        url: 'https://wikimedia.org/api/rest_v1/metrics/pageviews/top/' + this.project + '/' + ($(this.config.platformSelector).val() + '/' + topviewsDate),
        dataType: 'json'
      }).done(function (data) {
        ...
        if (entry) {
          ...
          var topviewsLink = '\n          <a target=\'_blank\' href=\'' + _this8.getTopviewsMonthURL(_this8.project + '.org', topviewsMonth) + '\'>most-viewed pages</a>\n        ';

          $('.single-page-ranking').html($.i18n('most-viewed-rank', entry.rank, topviewsLink, monthName + ' ' + topviewsMonth.year()));
        }
      }).always(function () {
        $('.table-view').hide();
        $('.single-page-stats').html('\n        ' + _this8.getPageLink(page.label) + '\n        ' + (page.assessment ? '&middot;\n' + page.assessment : '') + '\n        &middot;\n        <span class=\'text-muted\'>\n          ' + $(_this8.config.dateRangeSelector).val() + '\n        </span>\n        &middot;\n        ' + $.i18n('num-pageviews', _this8.formatNumber(page.sum)) + '\n        <span class=\'hidden-lg\'>\n          (' + _this8.formatNumber(page.average) + '/' + $.i18n('day') + ')\n        </span>\n      ');
    ...
    value: function updateTable() {
      ...
      var datasets = this.outputData.slice().sort(function (a, b) {
        var before = _this9.getSortProperty(a, _this9.sort),
            after = _this9.getSortProperty(b, _this9.sort);

        if (before < after) {
          return _this9.direction;
      ...
      datasets.forEach(function (item, index) {
        ...
        $('.output-list').append(_this9.config.templates.tableRow(_this9, item));
      });
      ...
      var totals = {
        ...
        protection: datasets.filter(function (page) {
    ...
    value: function getPageAndEditInfo(pages) {
      ...
      this.getPageInfo(pages).done(function (data) {
        ...
        _this10.getEditData(Object.keys(data)).done(function (editData) {
          for (var _page in editData.pages) {
            var pageData = editData.pages[_page];

            // find the edit protection within API response, or use the already fetched one if present
            var protection = _this10.entityInfo.entities[_page].protection || [];
            ...
            Object.assign(_this10.entityInfo.entities[_page], editData.pages[_page]);
          }
...
},{"./config":1,"./shared/chart_helpers":3,"./shared/pv":6,"./shared/site_map":8}],3:[function(require,module,exports){
'use strict';
...
},{"./zoom_plugin":9}],4:[function(require,module,exports){
'use strict';
...
var templates = {
  chartLegend: function chartLegend(scope) {
    var dataList = function dataList(entity) {
      var _$$i18n, _$$i18n2, _basicInfoMsg, _infoHash;
      ...
      var infoHash = (_infoHash = {}, _defineProperty(_infoHash, $.i18n('pageviews'), (_$$i18n = {}, _defineProperty(_$$i18n, $.i18n('pageviews'), scope.formatNumber(entity.sum)), _defineProperty(_$$i18n, $.i18n($('#date-type-select').val() + '-average'), scope.formatNumber(entity.average)), _$$i18n)), _defineProperty(_infoHash, $.i18n('revisions'), (_$$i18n2 = {}, _defineProperty(_$$i18n2, $.i18n('edits'), editsLink), _defineProperty(_$$i18n2, $.i18n('editors'), scope.formatNumber(entity.num_users)), _$$i18n2)), _defineProperty(_infoHash, basicInfoMsg, (_basicInfoMsg = {}, _defineProperty(_basicInfoMsg, $.i18n('watchers'), entity.watchers ? scope.formatNumber(entity.watchers) : $.i18n('unknown')), _defineProperty(_basicInfoMsg, $.i18n('size'), entity.length ? scope.formatNumber(entity.length) : ''), _basicInfoMsg)), _infoHash);

      if (!multiEntity) {
        var _Object$assign;

        Object.assign(infoHash[basicInfoMsg], (_Object$assign = {}, _defineProperty(_Object$assign, $.i18n('protection'), entity.protection), _defineProperty(_Object$assign, $.i18n('class'), entity.assessment), _Object$assign));
      }
  ...
  tableRow: function tableRow(scope, item) {
    ...
    if ($.isNumeric(item.num_edits)) {
      historyRow = last ? scope.formatNumber(item.num_edits) : scope.getHistoryLink(item.label, scope.formatNumber(item.num_edits));
    } else {
      historyRow = '?';
    }
