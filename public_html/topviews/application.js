...
var TopViews = function (_Pv) {
  ...
  _createClass(TopViews, [{
    ...
    key: 'percentMobile',
    value: function (_percentMobile) {
      function percentMobile(_x) {
        return _percentMobile.apply(this, arguments);
      }

      percentMobile.toString = function () {
        return _percentMobile.toString();
      };

      return percentMobile;
    }(function (item) {
      if (this.isYearly()) {
