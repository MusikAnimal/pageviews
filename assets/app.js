...
class App {
	 ...
	 * @param {String} [opts.level] One of 'success', 'info', 'warning', 'error'. Default is 'warning'.
	 * @param {Number} [opts.timeout] In seconds. Use 0 to show indefinitely. Default is 10 seconds.
	...
	processEnded() {
		...
		try {
			...
			// intentionally nothing, everything will still show
		}
